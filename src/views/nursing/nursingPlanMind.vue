  ...
  <div>
    ...
    <el-row>
      ...
      <div class="dayassesment-div">
        ...
        <el-button @click="isShow=!isShow">添加计划</el-button>
        <el-button @click="isShow=!isShow">删除计划</el-button>
        <el-button @click="isShow=!isShow">编辑计划</el-button>
        <el-button @click="dialogJump">评价</el-button>
    ...
    <el-dialog title="评价" :visible.sync="dialogVisible" width="700px">
      <div style="width:600px;height:200px;border:1px solid #ccc;margin-left:29px;">
        <p
          style="height:30px;background:#ddd;line-height:30px;text-indent:20px;font-size:16px;"
        >心动过速</p>
        <div style="width:540px;height:140px;margin:10px 30px;border:1px solid #ccc;">
          <div style="height:30px;background:#eee;display:flex;">
            <div
              style="width:270px;border-right:1px solid #ccc; line-height:30px;text-indent:20px;"
            >目标</div>
            <div style="flex:1;line-height:30px;text-indent:20px;">评价效果</div>
          </div>
          <div style="height:55px;border-bottom:1px solid #ccc; display:flex;">
            <div
              style="width:270px;border-right:1px solid #ccc;line-height:55px;text-indent:20px;"
            >胸闷心悸症状减轻</div>
            <div style="flex:1;">
              <div
                style="height:30px;margin-left:20px;margin-top:14px;width:225px;border:1px solid #ccc;display:flex;border-radius:15px;"
              >
                <div
                  style="flex:1;text-align:center;line-height:30px;border-right:1px solid #ccc;"
                >达到</div>
                <div style="flex:1;text-align:center;line-height:30px;">部分达到</div>
                <div
                  style="flex:1;text-align:center;line-height:30px;border-left:1px solid #ccc;"
                >未达到</div>
              </div>
            </div>
          </div>
      ...
      <div style="width:600px;height:200px;border:1px solid #ccc;margin-left:29px;margin-top:30px;">
        <p style="height:30px;background:#ddd;line-height:30px;text-indent:20px;font-size:16px;">发热</p>
        <div style="width:540px;height:140px;margin:10px 30px;border:1px solid #ccc;">
          <div style="height:30px;background:#eee;display:flex;">
            <div
              style="width:270px;border-right:1px solid #ccc; line-height:30px;text-indent:20px;"
      ...
      <span slot="footer" class="dialog-footer">
        <!-- <div style="text-align:left !important;position:relative;top:20px;">
          <span>时间</span>
...
export default {
  ...
  data() {
    return {
      ...
      timeArr: [], // 生成时间要合并的数组 [2,0,1,3,0,0] 代表第一二行合并,第三行不变,第四五六行合并,0代表原本的那一行被合并,因此这个列被消除
